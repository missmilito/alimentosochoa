...
<?php
	...
	function getRecords($params) {
	   ...
	   // getting total number records without any search
		$sql = "select a.id as idPedido, DATE_FORMAT(a.fechaped, '%Y/%m/%d') as fechanew, a.fechapag, datediff(a.fechapag, CURDATE()) dias, c.EstadoPed from tblpedido a,  tblestadopag b, tblestadoped c, tblcliente d  where  c.id = a.idestadoped and a.idcliente='" . $params["id"] . "' and d.id = a.idcliente and a.idestadopag = '1'";
