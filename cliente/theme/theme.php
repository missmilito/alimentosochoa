  ...
  <a target="_blank" href="#menu-toggle" style="color: #FFFFFF" class="btn navbar-brand"  id="menu-toggle"><span class="glyphicon glyphicon-list-alt "></span></a>
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right ">
                <li>
                    <a id="menu" style="color: #FFFFFF; background-color: #395DA1" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"><span style="font-family:arial;"> <?php echo $_SESSION['nombreusu'].' '.$_SESSION['apeusu'] ?></span></i><b class="caret"></b></a>
                    <ul id="menu" style="background-color: #395DA1; color: #FFFFFF" class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a id="menu" style="background-color: #395DA1; color: #FFFFFF" onclick="myFunction()" >Cerrar sesión.</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
