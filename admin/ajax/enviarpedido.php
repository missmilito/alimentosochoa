<?php
	...
	session_start();
		...
		if (isset($_POST['cliente'])){$idcliente=$_POST['cliente'];}
	...
	$convenio=date('Y-m-d', strtotime($date . " + ".$_POST['convenio']." day"));
		...
		{
		$idestado=$row["id"];
		$insert_pedido=mysqli_query($con, "INSERT INTO tblpedido ( id, fechaped, fechapag, observped, idestadoped, idcliente, idestadopag) VALUES ('$FACTURA','$date', '$convenio', '','$idestado', '$idcliente', '1')");
